...
## b.
```{r}
ENVS193_FinalData_Sheet1$Steps <- as.numeric(gsub(",", "", ENVS193_FinalData_Sheet1$Steps)) #making the step count a numeric value so they could be ordered lowest to highest
...
https://ars.els-cdn.com/content/image/1-s2.0-S0964569124004873-gr4_lrg.jpg
https://ars.els-cdn.com/content/image/1-s2.0-S0964569124004873-gr2_lrg.jpg
